...
def main():
    ...
    for fold in range(cfg.n_folds):
        ...
        train_fold_df, valid_fold_df, st2info, rain_df = preprocess(cfg, train_fold_df, valid_fold_df, water_st_df, rain_df, rain_st_df)
        train_loader, valid_loader = prepare_dataloader(cfg, train_fold_df, valid_fold_df, st2info, water_st_df, rain_df, rain_st_df)
