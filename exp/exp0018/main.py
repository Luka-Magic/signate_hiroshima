...
def main():
    ...
    for fold in range(cfg.n_folds):
        ...
        for epoch in range(1, cfg.n_epochs+1):
            # 学習
            train_score, train_loss, lr, teacher_forcing_ratio = train_one_epoch(cfg, epoch, train_loader, encoder, decoder, loss_fn, device, encoder_optimizer, decoder_optimizer, encoder_scheduler, decoder_scheduler, scheduler_step_time)
            # 推論
